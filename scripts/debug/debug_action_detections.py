...
from cr_bot.vision.yolo_runtime import build_detector, load_yolo_runtime, parse_box_row


DEFAULT_VIDEO = ROOT / "dataset_generation/data/video_clips/10_fps_2.6HogCycle.mp4"
DEFAULT_OUTPUT_DIR = ROOT / "outputs/debug/action_detection_debug"
