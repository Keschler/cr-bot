...
from cr_bot.app.main import has_visible_match_timer
...
def main():
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT / "outputs/debug/own_action_clock_cells_10_fps_gameplay")
